      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          <div className="flex gap-1">
            ...
            <HealthStatusBadge variant="normal" size="large">
              정상
            </HealthStatusBadge>
            <HealthStatusBadge variant="warning">경고</HealthStatusBadge>
            <HealthStatusBadge variant="warning" size="large">
              경고
            </HealthStatusBadge>
          </div>
          <div className="flex flex-col gap-1">
            <div className="flex gap-2">
              ...
              <CustomButton disabled>primary</CustomButton>
            </div>
            <div className="flex gap-2">
            ...
            <div className="flex gap-2">
              ...
              <CustomButton variant="warning" disabled>
                warning
              </CustomButton>
            </div>
          </div>
          ...
          <div className="flex gap-2">
            <Checkbox
              checked={checkboxhValue}
              size="small"
              onClick={() => setCheckboxhValue((prev) => !prev)}
            />
          ...
          <Input
            className="focus-visible:border-primary-300 focus-visible:shadow-primary-input"
            value={inputValue}
          ...
          />
          <Input
            className="border-palette-red focus-visible:shadow-error-input"
            value={errorInputValue}
            onChange={(event) => setErrorInputValue(event.target.value)}
          ...
          >
            ...
            <Select.SelectContent>
              ...
              <Select.SelectItem value="명동엘로세움">
                명동엘로세움
              </Select.SelectItem>
              <Select.SelectItem value="이편한세상 한숲시티">
                이편한세상 한숲시티
              </Select.SelectItem>
              <Select.SelectItem value="창원 롯데캐슬 하버팰리스">
                창원 롯데캐슬 하버팰리스
              </Select.SelectItem>
              <Select.SelectItem value="대구 롯데몰">
                대구 롯데몰
              </Select.SelectItem>
              <Select.SelectItem value="대구 롯데몰">
                대구 롯데몰
